...
<body>
    <div class="col-xs-12 col-md-12 col-lg-offset-1 col-lg-10 jumbotron cont-tron" id="content">
        <div id="topbar-contact">
            ...
            <div class="hidden-xs col-md-offset-5 col-md-3 col-lg-offset-5 col-lg-3">
        ...
        <div class="container col-xs-12 col-md-offset-3 col-md-3 col-lg-offset-3 col-lg-3 address">
